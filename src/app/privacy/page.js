...
const page = () => {
  return (
    <div className="px-3 px-md-2 px-lg-3 px-xl-5 mx-0 mx-md-2 mx-lg-3 mx-xl-5 pt-5 pb-5 privacyPolicy">
      <h1>Privacy Policy of Atrule Technologies</h1>

      <p>
        Atrule Technologies operates the https://atrule.com/ website, which
      ...
      <p>
        ...
        decided to use our Service, the Atrule Technologies website.
      </p>
      ...
      <p>
        ...
        Terms and Conditions, which is accessible at https://atrule.com/, unless
